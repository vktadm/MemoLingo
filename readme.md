...
- PostgreSQL
- SQLAlchemy
- Redis 1 - черный список jwt токенов
- Docker
***
### Функционал
#### Категории слов
...
- **Блок изучение слов**
  ...
  - [x] GET `/random`: Получаем 3 рандомных слова на английском
...
- **Аутентификация**
  ...
  - [x] GET `/users/about` : Получает информацию об авторизованном пользователе
***
### Инструкция по локальному развертыванию Docker
В процессе ...