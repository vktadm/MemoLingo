...
from backend.src.app.dependencies import get_word_service
from backend.src.app.schemas import WordSchema, CreateWordSchema, UpdateWordSchema
from backend.src.app.services import WordService
